...
here::i_am("R/Data_retrieval.qmd")
```
...
IMPORTANT: To download land use data you have to register here <https://land.copernicus.eu/en> for creating an API token. Then please save all the token information provided in a token.json which is in the project folder!
