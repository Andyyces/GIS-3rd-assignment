...
# Plot clc
top_labels <- names(sort(tapply(clc_nl_sf$Area_Ha, clc_nl_sf$code_label, sum), decreasing = TRUE))[1:7]
clc_nl_sf$filtered_label <- ifelse(clc_nl_sf$code_label %in% top_labels, clc_nl_sf$code_label, "Others")
